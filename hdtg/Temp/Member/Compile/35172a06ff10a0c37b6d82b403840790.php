...
<div class="container">
	...
	<!-- 载入公共头部文件-->
	<link href="http://a615268.sn20908.gzonet.net/hdtg/App/Member/Tpl/Public/css/cart.css" type="text/css" rel="stylesheet" >
	<script src="http://a615268.sn20908.gzonet.net/hdtg/App/Member/Tpl/Public/js/cart.js"/></script>
	<script>
		var __JSCONTROL__ = 'http://a615268.sn20908.gzonet.net/index.php/Member/Cart';
</script>
	<div class="container">
	<div class="check">	 
		 <div class="col-md-9 cart-items">
			 <h1>我的购物车 (<?php echo $cartnum;?>)</h1>
			 <form action="<?php echo U('Member/Buy/payment');?>" method="post">
			 <?php if(is_array($cart)):?><?php  foreach($cart as $k=>$v){ ?>
			 <div class="cart-header"></div>
				 <div class="close1"> </div>
				 <div class="cart-sec simpleCart_shelfItem">
						<div class="cart-item cyc">
							 <img src="<?php echo $v['goods_img'];?>" class="img-responsive" alt=""/>
						</div>
					   <div class="cart-item-info">
						<h3><a href="<?php echo U('Index/Detail/index');?>/gid/<?php echo $v['gid'];?>"><?php echo $v['main_title'];?></a><br><span>您的<?php echo $v['cart_id'];?>号购物车商品</span></h3>
						<ul class="goods-num">
						<li><p><a href="javascript:void(0);" class='reduce reduceGoods' ></a>
							...
							<a href="javascript:void(0);" class='add addGoods' ></a></p></li>
						</ul>
							 <div class="delivery">
							 <p>价格：<em class="font"><?php echo $v['price'];?>￥</em></p>
							 <br><br>
							 <span>下架时间：<em class="font"><?php echo date('Y-m-d',$v['end_time']);?></em></span>
							 <p>商品处于的状态：<em  class="font"><?php echo $v['status'];?></em></p>
							 <br><br>
							 <p>合计：<em class="font"><?php echo $v['xiaoji'];?>￥</em></p>
							
				        </div>	
					   </div>
					    <div class="clearfix"></div>
					   <div class="operate">
					   <input type="submit" class="btn btn-success btn-lg" value="购买">
					   <a id="my-cart" url="<?php echo U('Member/Cart/del');?>/gid/<?php echo $v['gid'];?>"   class="btn btn-danger btn-lg delCart" href="javascript:void(0);">删除</a>					 
					   </div>
					   <div class="clearfix"></div>
