...
<link rel="stylesheet" href="http://a615268.sn20908.gzonet.net/hdtg/App/Member/Tpl/Public/css/userinfo.css" />
	<!-- 载入公共头部文件-->
	<table class="table table-condensed">
	<tr>
		<td>我的用户名：<?php echo $username['uname'];?></td>
		<td></td>
	</tr>
	<tr>
		<td>我的邮箱:<?php echo $username['email'];?></td>
		<td></td>
	</tr>
	<tr>
		<td>我的电话:<?php echo $username['phone'];?></td>
		<td></td>
	</tr>
	<tr>
		<td>我的学校:<?php echo $username['school_name'];?></td>
		<td></td>
	</tr>
	<tr>
		<td>我的宿舍地址:<?php echo $username['user_floor'];?>栋<?php echo $username['user_level'];?><?php echo $username['user_room'];?></td>
		<td></td>
	</tr>
	<tr>
		<td></td>
		<td><a href="javascript:void(0)" class="btn btn-success">修改信息</a></td>
	</tr>
