...
<div id="content">
	<form id="goodsForm" action="<?php echo U('Member/Goods/add');?>" method="post">
...
<script type="text/javascript">
    $(function() {
        ...
        hd_uploadify_options.formData       ={image : "1", someOtherKey:1,hdsid:"j6jtvkdi68u9v3em4giovhpj53",upload_dir:"",hdphp_upload_thumb:"556,387,600,400,170,250"};
...
<div class="hd_uploadify_goods_img_files uploadify_upload_files" input_file_id ="hd_uploadify_goods_img">
    ...
    <div style="clear:both;"></div>
			...
			<tr>
				<td>商品服务</td>
				<td>
					<?php if(is_array($goods_server)):?><?php  foreach($goods_server as $k=>$v){ ?>
						<label>
    ...
    <script type='text/javascript'>
        ...
        ,wordCount:true //是否开启字数统计
			...
			<tr style="height:100px;">
				<td>&nbsp;</td>
				<td ><input type="submit" class='btn btn-success' value="添加商品"/></td>
			</tr>
		</tbody>
	</table>
	</form>
